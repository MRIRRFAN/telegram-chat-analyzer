# Chat after export looks like
# 06/11/21, 7:50 pm - Rahul Jamia: #Senior jawab do🤣
...
def preprocess(data):
    ...
    dates= re.findall(pattern,data)  #[' 06/11/21, 7:50 pm - ']
   ...
   #Now this df will get returned to app.py line 22
